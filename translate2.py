...
docx_path = os.path.join(downloads_path, 'Сертификат_анализа_пропранолол.docx')
doc.save(docx_path)

# Конвертируем документ в PDF
pdf_path = os.path.join(downloads_path, 'Сертификат_анализа_пропранолол.pdf')
convert(docx_path, pdf_path)

print(f"Документ сохранен как '{pdf_path}'")